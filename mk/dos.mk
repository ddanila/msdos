...
$(DOS_DIR)/CPMIO.OBJ: $(DOS_DIR)/CPMIO.ASM $(DOS_DIR)/STRIN.ASM $(DOS_DIR)/KSTRIN.ASM
...
$(DOS_DIR)/PROC.OBJ: $(DOS_DIR)/PROC.ASM $(DOS_DIR)/EXEC.ASM
...
$(DOS_DIR)/MSDOS.EXE: $(INC_NIBDOS) $(INC_CONST2) $(INC_MSDATA) \
	...
	# offsets into DOSGROUP rather than discovering them dynamically.
