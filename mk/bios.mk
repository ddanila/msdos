...
$(BIOS_DIR)/MSBIO1.OBJ: $(BIOS_DIR)/MSBIO1.ASM $(BIOS_DIR)/MSBDATA.INC $(BIOS_DIR)/DEVTABLE.INC $(BIOS_DIR)/DEVHEAD.INC \
    $(BIOS_DIR)/BDSFLOP.INC \
...
$(BIOS_DIR)/MSDISK.OBJ: $(BIOS_DIR)/MSDISK.ASM $(BIOS_DIR)/MSDSKHIG.INC $(BIOS_DIR)/MSMEDIA.INC $(BIOS_DIR)/HIDENSE.INC \
...
$(BIOS_DIR)/MSBIO2.OBJ: $(BIOS_DIR)/MSBIO2.ASM $(BIOS_DIR)/BDSPROC.INC $(BIOS_DIR)/MSBIO.CL2 \
    $(BIOS_DIR)/BDSHARD1.INC $(BIOS_DIR)/BDSHARD2.INC $(BIOS_DIR)/SWAPPROM.INC \
    $(BIOS_DIR)/MS96TPI.INC $(BIOS_DIR)/HIDENSE.INC $(BIOS_DIR)/MSCHKRSL.INC $(BIOS_DIR)/MSBSEG.INC
...
$(BIOS_DIR)/MSINIT.OBJ: $(BIOS_DIR)/MSINIT.ASM $(BIOS_DIR)/PACKBDS.INC $(BIOS_DIR)/CLOCKCONV.INC
...
$(BIOS_DIR)/SYSINIT1.OBJ: $(BIOS_DIR)/SYSINIT1.ASM $(BIOS_DIR)/HMAPLAN.INC $(BIOS_DIR)/TABLEUMB.INC $(BIOS_DIR)/DOSCOPY.INC \
    $(BIOS_DIR)/STKUPPER.INC \
    $(BIOS_DIR)/MSBIO.CL4 $(BIOS_DIR)/MSBIO.CL5
	cd $(BIOS_DIR) && $(MASM) "$(AFLAGS) $(BIOS_AINC)" "SYSINIT1.ASM,SYSINIT1.OBJ;"

$(BIOS_DIR)/SYSCONF.OBJ: $(BIOS_DIR)/SYSCONF.ASM $(BIOS_DIR)/BOOTBIOS.INC \
    $(BIOS_DIR)/PROVIDERDOWN.INC $(SRC)/INC/BOOTPROV.INC
