...
$(EMM_DIR)/EMMP.OBJ: $(EMM_DIR)/EMMP.ASM
	cd $(EMM_DIR) && $(MASM) "$(EMM_AFLAGS) -DEMMP_QUERY_ONLY -DEMMP_ATTR_EXCLUDE" "EMMP.ASM,EMMP.OBJ;"

$(EMM_DIR)/EMMATTR.OBJ: $(EMM_DIR)/EMMP.ASM
	cd $(EMM_DIR) && $(MASM) "$(EMM_AFLAGS) -DEMMP_QUERY_ONLY -DEMMP_ATTR_ONLY -DEMMP_SAVE_EXCLUDE -DEMMP_MAPPABLE_EXCLUDE" "EMMP.ASM,EMMATTR.OBJ;"
