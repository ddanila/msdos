...
$(HIMEM_DIR)/HIMEM.SYS: $(HIMEM_DIR)/HIMEM.ASM \
    ...
    $(HIMEM_DIR)/XMSBIND.INC $(HIMEM_DIR)/XMSFRAME.INC \
    $(HIMEM_DIR)/XMSMOVEBODY.INC $(HIMEM_DIR)/XMSMOVEHELP.INC $(HIMEM_DIR)/XMSMOVEGATE.INC \
    $(HIMEM_DIR)/XMSIMPORTBODY.INC $(HIMEM_DIR)/XMSIMPORTGATE.INC \
    $(HIMEM_DIR)/XMSBOOTFINISH.INC \
    $(HIMEM_DIR)/XMSADMINGATE.INC $(HIMEM_DIR)/XMSADMINBODY.INC $(HIMEM_DIR)/XMSADMINSTAGE.INC \
    $(HIMEM_DIR)/XMSUMBIMPORT.INC \
    $(HIMEM_DIR)/XMSUMBGATE.INC $(HIMEM_DIR)/XMSUMBBODY.INC \
    $(HIMEM_DIR)/BOOTCOPY.INC $(HIMEM_DIR)/TESTMEM386.INC \
...
$(COUNTRY_DIR)/MKCNTRY.OBJ: $(COUNTRY_DIR)/MKCNTRY.ASM \
    ...
    $(COUNTRY_DIR)/D5C850.INC $(COUNTRY_DIR)/RUCOUNTRY.INC $(COUNTRY_DIR)/BALTCOUN.INC
