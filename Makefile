...
.PHONY: test-ru-font-sources test-ru-contract test-ru-cpi test-ru-display-qemu test-utility-parser-coverage-manifest test-keyboard-records test-country-records test-country-matrix-qemu test-internal-structure-coverage-manifest test-internal-structures-qemu
