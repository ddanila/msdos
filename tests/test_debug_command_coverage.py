...
def main():
    ...
    derived = {
        "commands": debug_commands((ROOT / "src/CMD/DEBUG/DEBUG.ASM").read_text(encoding="latin-1")),
        "ems_subcommands": ems_subcommands((ROOT / "src/CMD/DEBUG/DEBEMS.ASM").read_text(encoding="latin-1")),
    }
