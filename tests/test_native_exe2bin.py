...
CASES = {
    ...
    "CMD/SETVER/SETVER.COM": ("CMD/SETVER/SETVERU.EXE", None),
    "CMD/DOSKEY/DOSKEY.COM": ("CMD/DOSKEY/DOSKEY.EXE", None),
    ...
    "DEV/SMARTDRV/SMARTDRV.SYS": ("DEV/SMARTDRV/SMARTDRVD.EXE", None),
