...
def main() -> int:
    ...
    # AH=33h/AL=06h now reports the actual HMA residency flag. Its ES-relative
    # CMP, short JE and MOV DH add ten bytes to the previously audited body.
    if dispatcher_start < low_gate or dispatcher_end > sysbuf or dispatcher_end - dispatcher_start != 818:
        errors.append("DOS dispatcher boundaries or audited 818-byte size changed")
