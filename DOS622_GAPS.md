...
| Additional DOS 6 locales | KEYBRD2.SYS, EGA2.CPI, EGA3.CPI, ISO.CPI, and associated data. Localized messages are outside the retail English baseline. The first scoped increment is [Russian / CP866](RUSSIAN.md). |
