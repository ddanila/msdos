...
| --- | --- | --- |
| DOS in the HMA and programs/drivers in UMBs | Implemented | HMA/UMB behavior is functional. EMM386 adds 33,280 conventional bytes in the comparison configuration and is gated below 40 KiB; see `MEMORY.md`. |
