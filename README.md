...
Stages 1-3 of the 6.22 roadmap, DOS UNDELETE, EGA.SYS, and full-screen Help are
complete. The next stage finishes SETUP/recovery media and observable API parity.
