...
gates; it is not a 545-byte movable routine. COMMAND's complete data owner is
already upper, so do not budget its old low copy again. A routing-only build or a larger diagnostic
