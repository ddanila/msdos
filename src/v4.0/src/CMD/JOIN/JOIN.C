...
/************************ BEGIN ***********************************************/
  ...
  if (c >= 2 && v[1][0] == '/' && v[1][1] == '?') {                          /* /? help */
    printf("Joins a drive to a directory on another drive.\r\n\r\n") ;
    printf("JOIN drive1: [drive2:]path\r\n") ;
    printf("JOIN drive1: /D\r\n") ;
    printf("JOIN\r\n\r\n") ;
    printf("  /D    Delete (remove) the specified JOIN\r\n\r\n") ;
    printf("Type JOIN with no parameters to display current joins.\r\n") ;
    exit(0) ;
    }                                                                          /* /? help */
