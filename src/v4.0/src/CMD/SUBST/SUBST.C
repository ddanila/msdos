...
/************************ BEGIN ***********************************************/
  ...
  if (c >= 2 && v[1][0] == '/' && v[1][1] == '?') {                          /* /? help */
    printf("Associates a path with a drive letter.\r\n\r\n") ;
    printf("SUBST [drive1: [drive2:]path]\r\n") ;
    printf("SUBST drive1: /D\r\n\r\n") ;
    printf("  /D    Delete a substitution\r\n\r\n") ;
    printf("Type SUBST with no parameters to display current substitutions.\r\n") ;
    exit(0) ;
    }                                                                          /* /? help */
