...
# Lisensi
Semua berkas dalam repo ini dirilis dalam [Lisensi MIT (OSI)](https://en.wikipedia.org/wiki/MIT_License) sesuai [berkas LISENSI](../LICENSE) yang disimpan di akar repo ini.
