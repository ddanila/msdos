...
/************************ BEGIN ***********************************************/
  ...
  if (argc >= 2 && argv[1][0] == '/' && argv[1][1] == '?') {                 /* /? help */
    printf("Replaces files in the destination with files from the source.\r\n\r\n") ;
    printf("REPLACE source [dest] [/A] [/P] [/R] [/S] [/U] [/W]\r\n\r\n") ;
    printf("  /A    Add new files to destination (cannot be used with /U or /S)\r\n") ;
    printf("  /P    Prompt before replacing or adding a file\r\n") ;
    printf("  /R    Replace read-only files as well as unprotected files\r\n") ;
    printf("  /S    Replace files in subdirectories (not with /A)\r\n") ;
    printf("  /U    Replace only files older than source files\r\n") ;
    printf("  /W    Wait for a keypress before beginning\r\n") ;
    exit(0) ;
    }                                                                          /* /? help */
